...
const YearExperience = "1";
  ...
  const statsData = useMemo(() => [
  {
    ...
    description: "UI/UX & frontend design projects",
  ...
  },
  {
    ...
    description: "Design & UX credentials",
    animation: "fade-up",
  },
  {
    icon: Globe,
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              >
                Anirudh Umamaheshwara Sai Chadaram
              </span>
            </h2>
...
I’m a UI/UX Designer who creates clean, intuitive, and user-friendly digital experiences. I combine research, problem-solving, and visual design to craft interfaces that feel simple from the first interaction.
With experience in web UI, prototyping, user flows, and usability testing, I enjoy transforming complex problems into meaningful solutions.

I also have frontend development knowledge (HTML, CSS, JavaScript), which helps me design developer-friendly and realistic interfaces.</p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1n-qPiU3SrJTyaJcFov3a0pT9DA9FvQ06/view?usp=drivesdk" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
